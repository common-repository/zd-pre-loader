 ...
 */
if ( !class_exists( 'tatom_Settings_API' ) ):
class tatom_Settings_API {
    ...
    function callback_textarea( $args ) {
        ...
        $html .= sprintf( '<br><p class="description"> %s</p>', $args['desc'] );
    ...
    function callback_wysiwyg( $args ) {
        ...
        echo sprintf( '<br><p class="description"> %s</p>', $args['desc'] );
    }
    ...
    function show_forms() {
        ...
        <div class="metabox-holder">
            <div class="postbox" style="padding-left: 25px">
