<?php 
	...
	<script type="text/javascript">
		    ...
		    jQuery(window).load(function() {
			    ...
			    jQuery(".spinner > div").css({"background-color": "<?php echo my_get_option( 'preloadcolor', 'tatom_basics', '#00A800' );?>"});
			    jQuery("#preloader").css({"background-color": "<?php echo my_get_option( 'prebackground', 'tatom_basics', '#fff' );?>"});
			})
		</script>
	<?php
	}
